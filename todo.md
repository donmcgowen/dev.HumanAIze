...
## Feature - Dexcom CSV/PDF Import and AI Analysis (v1.93)

### Phase 1: Database Schema
- [ ] Create glucose_readings table (timestamp, glucose_value, source, import_date)
- [ ] Create import_logs table (file_name, file_type, row_count, import_date, user_id)
- [ ] Add migration SQL for new tables

### Phase 2: CSV/PDF Parsing
- [ ] Implement CSV parser for Dexcom format
- [ ] Implement PDF parser for Dexcom reports
- [ ] Create tRPC procedure for file upload and parsing
- [ ] Validate and store parsed glucose data

### Phase 3: Glucose Analytics Section
- [ ] Create GlucoseAnalytics component
- [ ] Display Average Glucose box
- [ ] Display A1C estimate box
- [ ] Display Status indicator box
- [ ] Add CSV/PDF import buttons

### Phase 4: Gemini AI Insights
- [ ] Query food log data
- [ ] Query exercise data
- [ ] Query weight progress
- [ ] Call Gemini API with comprehensive health context
- [ ] Generate blood sugar insights and recommendations
- [ ] Display insights in Monitoring page

### Phase 5: 7-Day Glucose Graph
- [ ] Query last 7 days of glucose data
- [ ] Calculate daily averages
- [ ] Create Recharts line graph
- [ ] Display trend visualization

### Phase 6: Testing
- [ ] Test CSV import with sample Dexcom data
- [ ] Test PDF import functionality
- [ ] Verify glucose calculations (A1C estimate)
- [ ] Test Gemini AI recommendations
- [ ] Verify 7-day graph displays correctly
